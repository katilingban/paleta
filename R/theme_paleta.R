...
#' fonts in hierarchical order starting with *Roboto Condensed*, then
...
#' @param subtitle_colour Colour of the subtitle text. Default is NULL to use
#'   default [ggplot2] colour.
...
#'   set at 10.
#' @param caption_colour Colour of the caption text. Default is NULL.
...
#' @param axis_title_colour Colour of the axis title text. Default is NULL to
#'   use default [ggplot2] colour.
