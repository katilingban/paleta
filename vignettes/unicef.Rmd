...
```{r unicef-blue, echo = FALSE, fig.alt = "UNICEF Blue", fig.align = "center", fig.height = 1}
structure(unicef_blue, class = "palette", name = "UNICEF Blue")
```

Complementing **UNICEF Blue** is a set of 11 secondary colours.

```{r unicef-secondary, echo = FALSE, fig.alt = "UNICEF secondary colours palette", fig.align = "center", fig.height = 1}
...
```{r unicef-brights, echo = FALSE, fig.alt = "UNICEF bright colours palette", fig.align = "center", fig.height = 1}
structure(unicef_palettes$unicef_brights, class = "palette", name = "UNICEF Brights")
```

```{r unicef-neutrals, echo = FALSE, fig.alt = "UNICEF bright colours palette", fig.align = "center", fig.height = 1}
...
```{r unicef-theme-scatter, echo = FALSE, fig.alt = "A scatter plot showcasing the UNICEF ggplot2 theme", fig.align = "center", fig.showtext = TRUE, fig.height = 6, fig.width = 5, fig.retina = 1}
