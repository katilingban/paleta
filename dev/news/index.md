...
- changed Africa CDC colour palettes based on updated communication
  style guidelines
...
- created palette brewer functions for sequential, divergent, and
  qualitative colour palettes

### General updates

- refreshed `pkgdown` website
- refreshed GitHub Actions workflows to include Netlify pull request
  deployment
...
- fixed issue with `tint_colour*()` and `shade_colour*()` functions in
  which they return the opposite percentage tint or shade of a colour or
  a set of colours
...
- colours, fonts, palettes, and themes for Africa CDC, NHS, World Bank,
  and UNICEF;
- utilities for getting/searching colours from the different
  organisations; and,
